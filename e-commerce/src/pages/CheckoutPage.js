...
function CheckoutPage() {
  return (
    <div className="mx-auto max-w-7xl px-0  pt-8 sm:px-0 lg:px-0 ">
    <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
        <div className='lg:col-span-3  '>
        <form className='bg-white pl-4'>
      ...
      {addresses.map((address) => (
        <li key={address.name} className="flex justify-between gap-x-6 py-5  border-2 border-gray-700 p-4 mr-4 ">
          ...
          <input
                  ...
                  />
            <div className="min-w-0 flex-auto border-solid ">
          ...
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end mr-6">
        ...
        <div className="mx-auto max-w-7xl px-0 sm:px-0 lg:px-0 bg-white">
        <h2 className='text-4xl p-4 font-bold'>Cart</h2>
